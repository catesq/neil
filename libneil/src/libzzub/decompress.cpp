					  ...
					  DWORD dwNumSamples,BOOL bStereo)
{
	...
	{	//STEREO HANDLING
		...
		while(dwCount > 0)
		{
			...
			// denne testen ble ogs� flyttet fra bunn til topp av whilen
			...
			{	
				...
				// jeg tror nemlig at det g�r til helvete her...
				// s� - enten skal simularity fixes, eller -
				// det kommer litt hakk selv n�r vi har sumChannels til 0 p� 32-bit-floatene...
				if(btSumChannels != 0)
				{
					// KAN DET V�RE VI HAR EN SIGNED_BUG HER P� 32-BIT_TALL!??
